...
const ProfileCard = ( {user, fn} ) => {
  return (
    ...
    <Image
        ...
        width={60}
        height={60}
        className="rounded-full bg-white shadow-md border-2 border-white shadow-md"
        // style={{marginLeft: '1rem'}}
      />
      <p className='text-white 2rem text-blod p-1'>Name: {user.username}</p>
      <p className='text-white 2rem text-blod p-1'>Email: {user.email}</p>
        <svg className="p-1"  width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/profile">
        <p className="text-white 2rem text-blod">View Profile</p>
        </a>
        <svg className="p-1" width="28" height="33" viewBox="0 0 28 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a href="/">
<p className="text-white 2rem text-blod">Logout</p>
</a>
    </div>
  );
};
